...
public class AdminReservationServiceImpl implements IAdminReservationService {
    ...
    @Override
    public List<Map<String, String>> getAvailableSeatPositions(int fltCode, String seatClass, int pNum) {
        Map<String, Object> paramMap = new HashMap<>();
        paramMap.put("fltCode", fltCode);
        paramMap.put("seatClass", seatClass);
        paramMap.put("pNum", pNum);
        return dao.getAvailableSeatPositionsWithPassenger(paramMap);
    }
}
