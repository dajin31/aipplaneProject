...
//
//                List<Map<String, String>> seatPositions = reservationService.getAvailableSeatPositions(fltCode, seatClass, pNum);
//
//                System.out.println("조회된 좌석 위치 개수: " + (seatPositions != null ? seatPositions.size() : 0));
//
...
//
//                System.out.println("조회된 출발 시간 개수: " + (departureTimes != null ? departureTimes.size() : 0));
//
//                response.setContentType("application/json");
//                response.setCharacterEncoding("UTF-8");
//
