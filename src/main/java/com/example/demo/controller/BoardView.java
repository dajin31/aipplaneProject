...
public class BoardView extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        notice_boardService = Notice_BoardServiceImpl.getInstance();
    }
...
//      Notice_BoardService notice_boardService = Notice_BoardServiceImpl.getInstance();
        ...
        System.out.println(boardVO.getNtc_content());
        System.out.println(boardVO.getNtc_title());
        System.out.println(boardVO.getMod_time());
...
//        req.getSession().setAttribute("boardVO", boardVO);
        ...
        req.getRequestDispatcher("/member/test.jsp").forward(req,resp);
    }
}
